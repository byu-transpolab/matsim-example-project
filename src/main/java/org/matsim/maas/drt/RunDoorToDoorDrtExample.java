...
public class RunDoorToDoorDrtExample {
    ...
    private static final String COTTBUS_DOOR2DOOR_CONFIG = "scenarios/provo_orem/cottbus/drtconfig_door2door.xml";

	@SuppressWarnings("unused")
    private static final String MIELEC_CONFIG = "scenarios/provo_orem/cottbus/mielec_drt_config.xml";
